...
public class DemandeAmi {
    ...
    @ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL) //FetchType = LAZY est efficace dans les scenarios où j'ai pas besoiin de load citoyen à chaque fois que j'appelle DemandeAmi
